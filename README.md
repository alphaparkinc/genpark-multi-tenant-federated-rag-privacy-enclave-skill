# genpark-multi-tenant-federated-rag-privacy-enclave-skill
...
> **GenPark AI Agent Skill** -- Multi-tenant federated RAG privacy enclave & ZK attestation (Confidential RAG style)
